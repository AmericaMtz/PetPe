    ...
    <body>
        ...
        <% 
            ...
            try {
                ...
                out.print("<META HTTP-EQUIV='REFRESH' CONTENT='.0000001; URL=http://localhost:8080/PetPeti/PaginaPrincipal/index.html'/>");
                   }
                   else{
                       out.println("<script> alert('Los datos no coinciden.')</script>");
                       out.println("<META HTTP-EQUIV='REFRESH' CONTENT='.0000001; URL=http://localhost:8080/PetPeti/InicioDeSesion/InicioDeSesion.html'/>");
                   }
                } 
            catch (SQLException error) {
                    out.print(error.toString());
